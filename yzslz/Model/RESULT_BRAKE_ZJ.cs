namespace yzslz.Model
{
    ...
    public partial class RESULT_BRAKE_ZJ
    {
        ...
        [StringLength(8)]
        public string QZBPHLVBZ_1 { get; set; }

        [StringLength(8)]
        public string HZBPHLVBZDY60_1 { get; set; }

        [StringLength(8)]
        public string HZBPHLVBZXY60_1 { get; set; }

        [StringLength(12)]
        public string FHTZCZZ { get; set; }

        [StringLength(20)]
        public string YZKSSJ { get; set; }

        [StringLength(20)]
        public string YZJSSJ { get; set; }

        [StringLength(20)]
        public string EZKSSJ { get; set; }

        [StringLength(20)]
        public string EZJSSJ { get; set; }

        [StringLength(20)]
        public string SZKSSJ { get; set; }

        [StringLength(20)]
        public string SZJSSJ { get; set; }

        [StringLength(20)]
        public string SIZKSSJ { get; set; }

        [StringLength(20)]
        public string SIZJSSJ { get; set; }

        [StringLength(20)]
        public string WZKSSJ { get; set; }

        [StringLength(20)]
        public string WZJSSJ { get; set; }

        [StringLength(20)]
        public string LZKSSJ { get; set; }

        [StringLength(20)]
        public string LZJSSJ { get; set; }
    }
}
