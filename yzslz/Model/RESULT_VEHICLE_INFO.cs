namespace yzslz.Model
{
    ...
    public partial class RESULT_VEHICLE_INFO
    {
        ...
        [StringLength(50)]
        public string REPORT_JYXM { get; set; }
        ...
        [StringLength(200)]
        public string AJ_FJXM { get; set; }

        [StringLength(200)]
        public string ZJ_FJXM { get; set; }

        [StringLength(50)]
        public string WQ_FJXM { get; set; }

        [StringLength(200)]
        public string QT_FJXM { get; set; }
        ...
        [StringLength(4)]
        public string Z_RESULT { get; set; }
